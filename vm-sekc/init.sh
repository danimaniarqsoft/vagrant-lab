...
curl http://www-us.apache.org/dist/tomcat/tomcat-8/v8.5.14/bin/apache-tomcat-8.5.14.tar.gz > apache-tomcat-8.5.14.tar.gz
...
sudo curl -o /etc/systemd/system/tomcat.service https://gist.githubusercontent.com/danimaniarqsoft/558f361ccc5119cc4b47481b2b17b8b4/raw/c674504661fde0017e2221ec98d837e5e279709e/tomcat.service
